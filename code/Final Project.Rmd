---
title: "Settlers of Catan: Strategy Analysis"
output: html_notebook
---

Import Data from: https://www.kaggle.com/lumins/settlers-of-catan-games

```{r}
raw <- read.csv("catanstats.csv")
dprob <- read.csv("diceprob.csv")
```
...
stargazer(strat_means, 
          type="latex", 
          title = "Cluster Means",
          covariate.labels = c("","Strategy 1", "Strategy 2"),
          digits = 3,
          digits.extra = 3)
